<div class="bottom-bar" class="js-bottom-bar-user">
    ...
    <a rel="nofollow" class="item login" href="/login"><i class="fa fa-sign-in" aria-hidden="true"></i> Đăng nhập</a>
    <a rel="nofollow" class="item register" href="/register"><i class="fa fa-user-plus" aria-hidden="true"></i> Đăng
        ký</a>
</div>