    ...
    <div class="navbar-menu-container">
        ...
        <ul id="menu-main-menu" class="container-menu level-1">
            ...
            <li class="navbar_item {{ \Request::path() == 'chuyen-muc-'. $item->slug.'-'. $item->id ? 'active' : '' }}">
                <a href="{{ route('get.category.item',['slug' => $item->slug,'id' => $item->id]) }}" title="{{ $item->ten }}">{{ $item->ten }} </a>
            </li>
            @endforeach
            ...
            <div class="header-area">
                <div class="user-welcome js-reload-html-header">
                    ...
                    <div class="welcome-text">
                        ...
                        <img src="{{ pare_url_file(Auth::user()->anhdaidien) }}" style="width: 40px;height: 40px;border-radius: 50%" alt="">
                        @else
                        <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png" style="width: 40px;height: 40px;border-radius: 50%" alt="">
                        @endif
