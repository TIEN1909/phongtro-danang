<div class="card b-list-cate">
    ...
    <div class="card-body list-cate">
        <ul>
            ...
            <li>
                <a href="{{ route('get.category.item',['slug' => $item->slug,'id' => $item->id]) }}" title="{{ $item->ten }}">{{ $item->ten }} <span class="count">({{ $item->room_count }})</span></a>
            </li>
            @endforeach
            {{-- <li class="sub">--}}
            ...
            <div class="article-item">
                <a href="{{ route('get.room.blog_detail',['id' => $item->id,'slug' => $item->slug]) }}">
                    ...
                    <div class="article-info">
                        <h4 class="article-title">{{ $item->ten }}</h4>
                    </div>
                </a>
            </div>
            @endforeach
